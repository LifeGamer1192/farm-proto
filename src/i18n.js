...
const STRINGS = {
  en: {
    ...
    'panel.tips': 'Tips',
    'tips.1': 'Pick a tool, then click map tiles to order work. Colonists also take up jobs on their own.',
    'tips.2': 'Sowing spends a seed. Plant crops next to each other so a harvest cross-breeds their seeds.',
    'tips.3': 'The ★ rank shows seed quality — breed hardier, higher-yielding strains over the years.',
    'tips.4': 'Build a warehouse — colonists haul food into it, safe from pests, when on-hand stores fill up.',
    'tips.5': 'Keep a hearth lit through winter. A colonist out in the cold loses health and mood.',
  ...
  ja: {
    ...
    'panel.tips': 'ヒント',
    'tips.1': 'ツールを選び、マップをクリックして作業を指示。コロニストは自分でも仕事を取りに行きます。',
    'tips.2': '種まきは種を1つ消費。作物を隣り合わせて植えると、収穫時に種が交配します。',
    'tips.3': '★は種の品質。年を重ねて、丈夫で多収な品種に育種しましょう。',
    'tips.4': '倉庫を建てると、手持ちが一杯になった食料をコロニストが運び込み、虫害から守ります。',
    'tips.5': '冬はかまどの火を絶やさず。寒空のコロニストは体力と気分を失います。',
