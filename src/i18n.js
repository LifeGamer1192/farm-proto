...
const STRINGS = {
  en: {
    ...
    'log.warehouseNoWood': 'Warehouse expansion blocked — not enough wood.',
    'log.warehouseNoLand': 'Warehouse expansion blocked — no free land near the colony.',
    'log.cull': 'Culled {n} low-quality {crop} for selective breeding.',
    'log.cullSkipped': 'Selective-breeding cull skipped — colony food too low.',
  ...
  ja: {
    ...
    'log.warehouseNoWood': '倉庫の増設不可 — 材木が不足。',
    'log.warehouseNoLand': '倉庫の増設不可 — コロニー周辺に空地がない。',
    'log.cull': '品種改良のため低品質の{crop}を{n}件間引いた。',
    'log.cullSkipped': '食料が少なすぎるため品種改良の間引きを見送り。',
