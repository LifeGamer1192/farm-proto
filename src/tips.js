...
export const TIPS = [
  ...
  // --- genetics: extra Darwin / Mendel (α27 followup) --------------------
  { cat: 'genetics', en: 'Darwin sailed on the Beagle for five years, gathering specimens that hinted at species change.', ja: 'ダーウィンはビーグル号で5年間航海し、種の変化を示唆する標本を集めました。' },
  { cat: 'genetics', en: 'Galápagos finches each have a beak shaped for the food on their island.', ja: 'ガラパゴスのフィンチは、それぞれの島の食べ物に合った形のくちばしを持っています。' },
  { cat: 'genetics', en: '"On the Origin of Species" (1859) laid out evolution by natural selection.', ja: '『種の起源』(1859) は自然選択による進化を提示しました。' },
  { cat: 'genetics', en: 'Natural selection: individuals best suited to their environment leave more offspring.', ja: '自然選択: 環境に適した個体ほど多くの子孫を残します。' },
  { cat: 'genetics', en: 'Darwin called his idea "descent with modification" — change accumulating across generations.', ja: 'ダーウィンは自説を「変化を伴う由来」と呼びました。世代を越えて変化が積み上がります。' },
  { cat: 'genetics', en: 'Alfred Russel Wallace independently arrived at the same selection idea around 1858.', ja: '1858年頃、ウォレスは同じ「選択」の考えに独自にたどり着きました。' },
  { cat: 'genetics', en: 'Artificial selection (breeding) is the human-driven cousin of natural selection.', ja: '人為選択(育種)は、自然選択の人間版です。' },
  { cat: 'genetics', en: 'Darwin studied pigeon breeders to learn how rapid selection can reshape a population.', ja: 'ダーウィンはハトの育種家から、選抜がどれほど早く集団を変えるかを学びました。' },
  { cat: 'genetics', en: '"Survival of the fittest" was coined by Herbert Spencer, then adopted into Darwin\'s framework.', ja: '「適者生存」はスペンサーが造語し、後にダーウィンの体系に取り入れられました。' },
  { cat: 'genetics', en: '"Fitness" in biology means how many viable offspring an individual produces.', ja: '生物学の「適応度」は、ある個体が残せる繁殖可能な子の数です。' },
  { cat: 'genetics', en: 'Variation, inheritance and differential survival — the three ingredients selection needs.', ja: '変異・遺伝・生存差。選択が働くために必要な3つの素材です。' },
  { cat: 'genetics', en: 'Darwin and Mendel were contemporaries — but Darwin never knew of Mendel\'s peas.', ja: 'ダーウィンとメンデルは同時代人でしたが、ダーウィンはメンデルのエンドウ実験を知りませんでした。' },
  { cat: 'genetics', en: 'Mendel\'s 1866 paper sat unread for 34 years before its rediscovery in 1900.', ja: 'メンデルの1866年論文は34年間注目されず、1900年に再発見されました。' },
  { cat: 'genetics', en: 'Mendel grew about 28,000 pea plants over eight years to spot his ratios.', ja: 'メンデルは8年間で約28,000株のエンドウマメを育て、比率を見つけ出しました。' },
  { cat: 'genetics', en: 'Mendel\'s famous 3:1 ratio appears in the second generation of a cross between true-breeding parents.', ja: 'メンデルの有名な3:1の比は、純系の親同士の交配の第2世代に現れます。' },
  { cat: 'genetics', en: 'In peas Mendel tracked seven contrasting traits, including round vs wrinkled seeds.', ja: 'メンデルはエンドウマメで、丸い種と皺の種など7つの対照形質を追いました。' },
  { cat: 'genetics', en: 'A heterozygote carries two different alleles; a homozygote carries two of the same.', ja: 'ヘテロ接合は対立遺伝子が異なり、ホモ接合は同じ対立遺伝子を2つ持ちます。' },
  { cat: 'genetics', en: 'In a Punnett square, each cell is one possible offspring genotype with equal probability.', ja: 'パネットの方形の各マスは、子の遺伝子型の可能な組み合わせを等確率で示します。' },
  { cat: 'genetics', en: 'A test cross with a recessive parent reveals whether the other parent is homo- or heterozygous.', ja: '潜性親との検定交雑で、もう一方の親がホモかヘテロかを判別できます。' },
  { cat: 'genetics', en: 'Two genes on the same chromosome can be inherited together — that is genetic linkage.', ja: '同じ染色体上の2つの遺伝子は一緒に受け継がれることがあり、これを「連鎖」と呼びます。' },
  { cat: 'genetics', en: 'Crossing-over during meiosis shuffles linked genes — the deeper source of variety.', ja: '減数分裂中の交差は連鎖した遺伝子を組み換え、多様性の根源となります。' },
  { cat: 'genetics', en: 'Incomplete dominance: a red × white snapdragon makes a pink, not red, hybrid.', ja: '不完全顕性: 赤と白のキンギョソウを掛けると、子はピンクになります。' },
  { cat: 'genetics', en: 'Co-dominance: both alleles show fully — like a red-and-white spotted cattle hide.', ja: '共顕性: 両方の対立遺伝子が同時に表れる例として、赤白まだらの牛があります。' },
  { cat: 'genetics', en: 'Many real traits are polygenic — combinations of several genes producing a smooth range.', ja: '実際の形質の多くは多遺伝子性で、複数の遺伝子の組み合わせで滑らかに変化します。' },
  { cat: 'genetics', en: 'Allele frequency in a population shifts every generation; that drift is evolution at work.', ja: '集団内の対立遺伝子頻度は世代ごとに変動します。この遺伝的浮動こそ進化の働きです。' },
  { cat: 'genetics', en: 'A bottleneck (a few survivors) can lock the next generation into the alleles those few carried.', ja: '生存者がわずかになる「ボトルネック」では、次世代はその少数の対立遺伝子に縛られます。' },
  { cat: 'genetics', en: 'Founder effect: a small group migrating to a new place carries only its narrow gene pool.', ja: '創始者効果: 新天地に渡った少数集団は、限られた遺伝子プールしか持ち込めません。' },
  { cat: 'genetics', en: 'Hardy-Weinberg equilibrium predicts gene frequencies when no selection or mutation acts.', ja: 'ハーディ・ワインベルクの法則は、選択も突然変異もないときの遺伝子頻度を予言します。' },
  { cat: 'genetics', en: 'Speciation can happen when two populations diverge enough that they no longer interbreed.', ja: '種分化は、2つの集団が分かれて、交配しなくなるほど離れたときに起きます。' },
  { cat: 'genetics', en: 'A long-term selection experiment in maize ran for 100+ generations, doubling oil content.', ja: 'トウモロコシの長期選抜実験は100世代以上続き、油分含量を倍に伸ばしました。' },
